    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[700px]">
        <div className="lg:col-span-1 space-y-3 overflow-y-auto pr-2 custom-scrollbar">
          ...
          {(Object.values(ROLES) as RoleData[]).map((role: RoleData) => (
            <button
              key={role.id}
              ...
              <div className="overflow-y-auto pr-4 custom-scrollbar h-full">
                ...
                <div className="space-y-6 relative z-10">
                  <div className="space-y-4">
                     {GAME_OVERVIEW.mechanics.map((mech: { title: string; content: string }, idx: number) => (
              ...
              <div className="overflow-y-auto pr-4 custom-scrollbar h-full">
                ...
                <div className="space-y-6 relative z-10">
                  <div className="grid grid-cols-1 gap-4">
                    {GAME_OVERVIEW.sdgs.map((sdg: { id: string; title: string; desc: string }, idx: number) => (
