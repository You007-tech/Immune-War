...
const KnowledgeBase: React.FC = () => {
  ...
  // 将 ROLES 显式转换为数组以解决 TS 检查问题
  const roleList: RoleData[] = Object.values(ROLES);
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[700px]">
        <div className="lg:col-span-1 space-y-3 overflow-y-auto pr-2 custom-scrollbar">
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-slate-500 font-bold uppercase tracking-tighter">RULES & MECHANICS</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-slate-500 font-bold uppercase tracking-tighter">SUSTAINABLE DEVELOPMENT</div>
            </div>
          </button>
        ...
        <div className="lg:col-span-2 h-full">
          <div className="bg-slate-900 border border-slate-700 rounded-2xl p-8 h-full shadow-2xl relative overflow-hidden flex flex-col">
              ...
              <div className="overflow-y-auto pr-4 custom-scrollbar h-full">
                <div className="flex items-center gap-4 mb-6 border-b border-slate-700 pb-6">
                  ...
                  <div>
                    ...
                    <span className="text-bio-primary font-bold text-xs tracking-widest">{ROLES[selectedTab as RoleType].faction}</span>
                  </div>
                </div>
                <div className="space-y-6">
                  ...
                  <div className="bg-slate-800/80 p-5 rounded-xl border border-slate-700">
                    <h4 className="text-bio-primary font-bold mb-2 text-xs uppercase tracking-widest">特殊能力</h4>
                    <p className="text-white font-bold text-lg">{ROLES[selectedTab as RoleType].ability}</p>
                  </div>
